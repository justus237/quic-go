...
func populateConfig(config *Config) *Config {
	...
	return &Config{
		...
		EnableFrontDefense:               config.EnableFrontDefense,
		FrontDefenseSlidingWindow:        config.FrontDefenseSlidingWindow,
		FrontDefenseMaxServerPackets:     config.FrontDefenseMaxServerPackets,
		FrontDefensePeakMin:              config.FrontDefensePeakMin,
		FrontDefensePeakMax:              config.FrontDefensePeakMax,
